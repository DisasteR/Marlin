...
#define STRING_CONFIG_H_AUTHOR "(DisasteR, Ender-3 Pro)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 101.31
  #define DEFAULT_bedKi  19.75
  #define DEFAULT_bedKd 346.51
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 38.2, 0, -1.66 }
...
#define X_MIN_POS 0
#define Y_MIN_POS -18.0
#define Z_MIN_POS 0
#define X_MAX_POS X_BED_SIZE
// #define Y_MAX_POS Y_BED_SIZE
// Remove Y_MIN_POS from Y_BED_SIZE
